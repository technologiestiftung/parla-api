CREATE INDEX processed_document_chunks_embedding_idx ON public.processed_document_chunks USING ivfflat (embedding) WITH (lists='83');

CREATE INDEX processed_document_chunks_embedding_idx1 ON public.processed_document_chunks USING ivfflat (embedding vector_ip_ops) WITH (lists='83');

CREATE INDEX processed_document_chunks_embedding_idx2 ON public.processed_document_chunks USING ivfflat (embedding vector_cosine_ops) WITH (lists='83');

CREATE INDEX processed_document_summaries_summary_embedding_idx6 ON public.processed_document_summaries USING ivfflat (summary_embedding) WITH (lists='9');

CREATE INDEX processed_document_summaries_summary_embedding_idx7 ON public.processed_document_summaries USING ivfflat (summary_embedding vector_ip_ops) WITH (lists='9');

CREATE INDEX processed_document_summaries_summary_embedding_idx8 ON public.processed_document_summaries USING ivfflat (summary_embedding vector_cosine_ops) WITH (lists='9');
